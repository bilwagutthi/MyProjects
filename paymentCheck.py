...
# Finding pay button and clicking it
pay_button=browser.find_element_by_xpath('//button[@type="submit"]')
pay_button.click()
...
mmyy_element=browser.find_element_by_xpath('//input[@placeholder="MM / YY"]')
mmyy_element.send_keys("221")

cvc_element=browser.find_element_by_xpath('//input[@placeholder="CVC"]')
cvc_element.send_keys("321")

zip_element=browser.find_element_by_xpath('//input[@placeholder="ZIP Code"]')
zip_element.send_keys("321999")

checkbox_element=browser.find_element_by_xpath('//a[@class="Checkbox"]')
checkbox_element.click()

phno_element=browser.find_element_by_xpath('//input[@autocomplete="mobile tel"]')
phno_element.send_keys("8899776655")
...
if (browser.current_url=="https://weathershopper.pythonanywhere.com/confirmation"):
    ...
    if(payment_check=="PAYMENT SUCCESS"):
        print("Payment details entered successfully and payment success")
    elif (payment_check=='PAYMENT FAILED'):
        print("Payment details entered successfully and payment failed")
    else:
        print("Error occured during payment")
